"""Every observation of one feature, fetched from the store and cut into its patches."""
...
def load_patches(
    ...
    Args:
        observations: The feature's own index rows, every observation the build holds
            of it.
